...
ruby scrape_and_output.rb input/kawasaki_data.txt > output/kawasaki_output.txt
ruby scrape_and_output.rb input/sagamihara_data.txt > output/sagamihara_output.txt
